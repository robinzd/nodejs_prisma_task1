...
export namespace Prisma {
  ...
  */
  ...
  /**
   * Count Type Orders_tblCountOutputType
   */


  export type Orders_tblCountOutputType = {
    deliver_status: number
  }

  export type Orders_tblCountOutputTypeSelect = {
    deliver_status?: boolean
  }

  export type Orders_tblCountOutputTypeGetPayload<
    S extends boolean | null | undefined | Orders_tblCountOutputTypeArgs,
    U = keyof S
      > = S extends true
        ? Orders_tblCountOutputType
    : S extends undefined
    ? never
    : S extends Orders_tblCountOutputTypeArgs
    ?'include' extends U
    ? Orders_tblCountOutputType 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
    P extends keyof Orders_tblCountOutputType ? Orders_tblCountOutputType[P] : never
  } 
    : Orders_tblCountOutputType
  : Orders_tblCountOutputType
  ...
  /**
   * Orders_tblCountOutputType without action
   */
  export type Orders_tblCountOutputTypeArgs = {
    /**
     * Select specific fields to fetch from the Orders_tblCountOutputType
     * 
    **/
    select?: Orders_tblCountOutputTypeSelect | null
  }
  ...
  export type orders_tblSelect = {
    ...
    deliver_status?: boolean | deliver_statusFindManyArgs
    _count?: boolean | Orders_tblCountOutputTypeArgs
  }
  ...
  export type orders_tblGetPayload<
    ...
    ? orders_tbl  & {
    [P in TrueKeys<S['include']>]:
        P extends 'customer_tbl' ? customer_tblGetPayload<S['include'][P]> | null :
        P extends 'deliver_status' ? Array < deliver_statusGetPayload<S['include'][P]>>  :
        P extends '_count' ? Orders_tblCountOutputTypeGetPayload<S['include'][P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'customer_tbl' ? customer_tblGetPayload<S['select'][P]> | null :
        P extends 'deliver_status' ? Array < deliver_statusGetPayload<S['select'][P]>>  :
        P extends '_count' ? Orders_tblCountOutputTypeGetPayload<S['select'][P]> :  P extends keyof orders_tbl ? orders_tbl[P] : never
  } 
    : orders_tbl
  : orders_tbl
  ...
  export type deliver_statusSelect = {
    ...
    customer_id?: boolean
    product_id?: boolean
    orders_tbl?: boolean | orders_tblArgs
    customer_tbl?: boolean | customer_tblArgs
  }
  ...
  export type deliver_statusGetPayload<
    ...
    ? deliver_status  & {
    [P in TrueKeys<S['include']>]:
        P extends 'orders_tbl' ? orders_tblGetPayload<S['include'][P]> | null :
        P extends 'customer_tbl' ? customer_tblGetPayload<S['include'][P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'orders_tbl' ? orders_tblGetPayload<S['select'][P]> | null :
  ...
  export class Prisma__deliver_statusClient<T> implements PrismaPromise<T> {
    ...
    orders_tbl<T extends orders_tblArgs = {}>(args?: Subset<T, orders_tblArgs>): CheckSelect<T, Prisma__orders_tblClient<orders_tbl | null >, Prisma__orders_tblClient<orders_tblGetPayload<T> | null >>;
  ...
  export type deliver_statusWhereInput = {
    ...
    orders_tbl?: XOR<Orders_tblRelationFilter, orders_tblWhereInput> | null
  ...
  export type deliver_statusOrderByWithRelationInput = {
    ...
    orders_tbl?: orders_tblOrderByWithRelationInput
    customer_tbl?: customer_tblOrderByWithRelationInput
  }
  ...
  export type orders_tblCreateInput = {
    ...
    deliver_status?: deliver_statusCreateNestedManyWithoutOrders_tblInput
  }
  ...
  export type orders_tblUncheckedCreateInput = {
    ...
    Product_price?: number | null
    customer_id?: number | null
    deliver_status?: deliver_statusUncheckedCreateNestedManyWithoutOrders_tblInput
  }
  ...
  export type orders_tblUpdateInput = {
    ...
    deliver_status?: deliver_statusUpdateManyWithoutOrders_tblNestedInput
  }
  ...
  export type orders_tblUncheckedUpdateInput = {
    ...
    deliver_status?: deliver_statusUncheckedUpdateManyWithoutOrders_tblNestedInput
  }
  ...
  export type deliver_statusCreateInput = {
    status: number
    orders_tbl?: orders_tblCreateNestedOneWithoutDeliver_statusInput
  ...
  export type deliver_statusUpdateInput = {
    ...
    orders_tbl?: orders_tblUpdateOneWithoutDeliver_statusNestedInput
  ...
  export type Orders_tblRelationFilter = {
    is?: orders_tblWhereInput | null
    isNot?: orders_tblWhereInput | null
  }
  ...
  export type deliver_statusCreateNestedManyWithoutOrders_tblInput = {
    create?: XOR<Enumerable<deliver_statusCreateWithoutOrders_tblInput>, Enumerable<deliver_statusUncheckedCreateWithoutOrders_tblInput>>
    connectOrCreate?: Enumerable<deliver_statusCreateOrConnectWithoutOrders_tblInput>
    createMany?: deliver_statusCreateManyOrders_tblInputEnvelope
    connect?: Enumerable<deliver_statusWhereUniqueInput>
  }

  export type deliver_statusUncheckedCreateNestedManyWithoutOrders_tblInput = {
    create?: XOR<Enumerable<deliver_statusCreateWithoutOrders_tblInput>, Enumerable<deliver_statusUncheckedCreateWithoutOrders_tblInput>>
    connectOrCreate?: Enumerable<deliver_statusCreateOrConnectWithoutOrders_tblInput>
    createMany?: deliver_statusCreateManyOrders_tblInputEnvelope
    connect?: Enumerable<deliver_statusWhereUniqueInput>
  ...
  export type deliver_statusUpdateManyWithoutOrders_tblNestedInput = {
    create?: XOR<Enumerable<deliver_statusCreateWithoutOrders_tblInput>, Enumerable<deliver_statusUncheckedCreateWithoutOrders_tblInput>>
    connectOrCreate?: Enumerable<deliver_statusCreateOrConnectWithoutOrders_tblInput>
    upsert?: Enumerable<deliver_statusUpsertWithWhereUniqueWithoutOrders_tblInput>
    createMany?: deliver_statusCreateManyOrders_tblInputEnvelope
    set?: Enumerable<deliver_statusWhereUniqueInput>
    disconnect?: Enumerable<deliver_statusWhereUniqueInput>
    delete?: Enumerable<deliver_statusWhereUniqueInput>
    connect?: Enumerable<deliver_statusWhereUniqueInput>
    update?: Enumerable<deliver_statusUpdateWithWhereUniqueWithoutOrders_tblInput>
    updateMany?: Enumerable<deliver_statusUpdateManyWithWhereWithoutOrders_tblInput>
    deleteMany?: Enumerable<deliver_statusScalarWhereInput>
  }

  export type deliver_statusUncheckedUpdateManyWithoutOrders_tblNestedInput = {
    create?: XOR<Enumerable<deliver_statusCreateWithoutOrders_tblInput>, Enumerable<deliver_statusUncheckedCreateWithoutOrders_tblInput>>
    connectOrCreate?: Enumerable<deliver_statusCreateOrConnectWithoutOrders_tblInput>
    upsert?: Enumerable<deliver_statusUpsertWithWhereUniqueWithoutOrders_tblInput>
    createMany?: deliver_statusCreateManyOrders_tblInputEnvelope
  ...
  export type orders_tblCreateNestedOneWithoutDeliver_statusInput = {
    create?: XOR<orders_tblCreateWithoutDeliver_statusInput, orders_tblUncheckedCreateWithoutDeliver_statusInput>
    connectOrCreate?: orders_tblCreateOrConnectWithoutDeliver_statusInput
    connect?: orders_tblWhereUniqueInput
  }
  ...
  export type orders_tblUpdateOneWithoutDeliver_statusNestedInput = {
    create?: XOR<orders_tblCreateWithoutDeliver_statusInput, orders_tblUncheckedCreateWithoutDeliver_statusInput>
    connectOrCreate?: orders_tblCreateOrConnectWithoutDeliver_statusInput
    upsert?: orders_tblUpsertWithoutDeliver_statusInput
    disconnect?: boolean
    delete?: boolean
    connect?: orders_tblWhereUniqueInput
    update?: XOR<orders_tblUpdateWithoutDeliver_statusInput, orders_tblUncheckedUpdateWithoutDeliver_statusInput>
  }
  ...
  export type deliver_statusCreateWithoutOrders_tblInput = {
    status: number
    customer_tbl: customer_tblCreateNestedOneWithoutDeliver_statusInput
  }

  export type deliver_statusUncheckedCreateWithoutOrders_tblInput = {
    ID?: number
    status: number
    customer_id: number
  }

  export type deliver_statusCreateOrConnectWithoutOrders_tblInput = {
    where: deliver_statusWhereUniqueInput
    create: XOR<deliver_statusCreateWithoutOrders_tblInput, deliver_statusUncheckedCreateWithoutOrders_tblInput>
  }

  export type deliver_statusCreateManyOrders_tblInputEnvelope = {
    data: Enumerable<deliver_statusCreateManyOrders_tblInput>
    skipDuplicates?: boolean
  }
  ...
  export type deliver_statusUpsertWithWhereUniqueWithoutOrders_tblInput = {
    where: deliver_statusWhereUniqueInput
    update: XOR<deliver_statusUpdateWithoutOrders_tblInput, deliver_statusUncheckedUpdateWithoutOrders_tblInput>
    create: XOR<deliver_statusCreateWithoutOrders_tblInput, deliver_statusUncheckedCreateWithoutOrders_tblInput>
  }

  export type deliver_statusUpdateWithWhereUniqueWithoutOrders_tblInput = {
    where: deliver_statusWhereUniqueInput
    data: XOR<deliver_statusUpdateWithoutOrders_tblInput, deliver_statusUncheckedUpdateWithoutOrders_tblInput>
  }

  export type deliver_statusUpdateManyWithWhereWithoutOrders_tblInput = {
    where: deliver_statusScalarWhereInput
    data: XOR<deliver_statusUpdateManyMutationInput, deliver_statusUncheckedUpdateManyWithoutDeliver_statusInput>
  }

  export type orders_tblCreateWithoutDeliver_statusInput = {
    product_name?: string | null
    Product_price?: number | null
    customer_tbl?: customer_tblCreateNestedOneWithoutOrders_tblInput
  }

  export type orders_tblUncheckedCreateWithoutDeliver_statusInput = {
    ID?: number
    product_name?: string | null
    Product_price?: number | null
    customer_id?: number | null
  ...
  export type orders_tblCreateOrConnectWithoutDeliver_statusInput = {
    where: orders_tblWhereUniqueInput
    create: XOR<orders_tblCreateWithoutDeliver_statusInput, orders_tblUncheckedCreateWithoutDeliver_statusInput>
  }
  ...
  export type orders_tblUpsertWithoutDeliver_statusInput = {
    update: XOR<orders_tblUpdateWithoutDeliver_statusInput, orders_tblUncheckedUpdateWithoutDeliver_statusInput>
    create: XOR<orders_tblCreateWithoutDeliver_statusInput, orders_tblUncheckedCreateWithoutDeliver_statusInput>
  }

  export type orders_tblUpdateWithoutDeliver_statusInput = {
    product_name?: NullableStringFieldUpdateOperationsInput | string | null
    Product_price?: NullableIntFieldUpdateOperationsInput | number | null
    customer_tbl?: customer_tblUpdateOneWithoutOrders_tblNestedInput
  }

  export type orders_tblUncheckedUpdateWithoutDeliver_statusInput = {
    ID?: IntFieldUpdateOperationsInput | number
    product_name?: NullableStringFieldUpdateOperationsInput | string | null
    Product_price?: NullableIntFieldUpdateOperationsInput | number | null
    customer_id?: NullableIntFieldUpdateOperationsInput | number | null
  ...
  export type deliver_statusCreateManyOrders_tblInput = {
    ID?: number
    status: number
    customer_id: number
  }

  export type deliver_statusUpdateWithoutOrders_tblInput = {
    status?: IntFieldUpdateOperationsInput | number
    customer_tbl?: customer_tblUpdateOneRequiredWithoutDeliver_statusNestedInput
  }

  export type deliver_statusUncheckedUpdateWithoutOrders_tblInput = {
    ID?: IntFieldUpdateOperationsInput | number
    status?: IntFieldUpdateOperationsInput | number
    customer_id?: IntFieldUpdateOperationsInput | number
  }
